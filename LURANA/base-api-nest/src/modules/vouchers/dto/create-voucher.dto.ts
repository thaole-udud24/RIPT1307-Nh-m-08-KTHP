...
export class CreateVoucherDto {
  @IsNotEmpty()
  @IsString()
  @Matches(VOUCHER_CODE_REGEX, {
    message: 'Mã voucher chỉ được chứa chữ hoa, số và dấu gạch dưới.',
  })
  voucherCode!: string;
  ...
  @IsOptional()
  @Matches(/^\d{2}:\d{2}$/, {
    message: 'Giờ bắt đầu phải ở định dạng HH:mm.',
  })
  goldenHourStart?: string;

  @IsOptional()
  @Matches(/^\d{2}:\d{2}$/, {
    message: 'Giờ kết thúc phải ở định dạng HH:mm.',
  })

import { UserOutlined, PhoneOutlined, EnvironmentOutlined, FormOutlined } from '@ant-design/icons';
import type { OrderShippingAddress } from '@/services/DonHang/types';
...
export default function CustomerInfo({ address, note }: CustomerInfoProps) {
  
  // Nền bo góc nhạt cho icon chuẩn UI 2025
